...
// POST - /user
export async function createUser(payload: object): Promise<object> {
    try {
...
// PUT - /user/:id
export async function updateUser(id: string, payload: object): Promise<object> {
    try {
...
// DELETE - /user/:id
export async function deleteUser(id: string): Promise<object> {
    try {
